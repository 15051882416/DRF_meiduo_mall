...
SECRET_KEY = 'e^-dski@a(ed_b9=+7g41canz+13ix7cuewww48t3wfm_2-b9t'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# 允许哪些域名可以来访问美多,默认只能由127.0.0.1:8000
ALLOWED_HOSTS = ['www.meiduo.site']


# Application definition
# 注册应用: 只有当应用中需要模型迁移时,
# 以及使用'模板'时,才需要注册应用,其它情况可以不注册
INSTALLED_APPS = [
...
SESSION_CACHE_ALIAS = "session"   # 让它缓存到1号redis数据库
...
# 指定登录界面的路由
LOGIN_URL = '/login/'   #login_required装饰器 判断用户是否登录,如果未通过登录验证则被重定向到LOGIN_URL配置项指定的地址
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.111.151:9200/',  # Elasticsearch服务器ip地址，端口号固定为9200
